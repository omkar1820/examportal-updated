...
public class DBConnection {
    ...
    private static final String DB   = System.getenv().getOrDefault("DB_NAME", "examportal");
    private static final String USER = System.getenv().getOrDefault("DB_USER", "root");
    private static final String PASS = System.getenv().getOrDefault("DB_PASS", "root123");

    private static final String URL =
        "jdbc:mysql://" + HOST + ":" + PORT + "/" + DB + "?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true";
